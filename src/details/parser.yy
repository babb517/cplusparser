...
%defines "parser.hh"
%output "parser.cc"
%define namespace "cplus_parser::details"
...
%nonassoc <integer> T_EQ 								// =
%nonassoc <integer> T_DBL_EQ T_NOT_EQ T_LTHAN T_GTHAN T_EQ_LTHAN T_GTHAN_EQ		// ==, \= or <> or neq, <, >, =<, >=
							...
							| NOT cl_body_formula %prec T_UMINUS
{
	$$ = new SimpleUnaryOperator(SimpleUnaryOperator::UOP_NOT, $2);
							...
							| cl_body_formula AND %prec T_AMP cl_body_formula
{
	$$ = new SimpleBinaryOperator($1, SimpleBinaryOperator::BOP_AND, $3);
}
							| cl_body_formula T_DBL_PLUS cl_body_formula
{
							...
							| extended_value_expression T_EQ extended_value_expression
{
	$$ = new SimpleBinaryOperator($1, SimpleBinaryOperator::BOP_EQ, $3);
							...
							| extended_value_expression T_NOT_EQ extended_value_expression
{
	$$ = new SimpleBinaryOperator($1, SimpleBinaryOperator::BOP_NEQ, $3);
}
							| extended_value_expression COMPARISON %prec T_DBL_EQ extended_value_expression
{
							...
							| NOT cl_body_formula_bool %prec T_UMINUS
{
	$$ = new SimpleUnaryOperator(SimpleUnaryOperator::UOP_NOT, $2);
							...
							| cl_body_formula_bool AND %prec T_AMP cl_body_formula_bool
{
	$$ = new SimpleBinaryOperator($1, SimpleBinaryOperator::BOP_AND, $3);
}
							| cl_body_formula_bool T_DBL_PLUS cl_body_formula_bool
{
	$$ = new SimpleBinaryOperator($1, SimpleBinaryOperator::BOP_OR, $3);
}
							...
							| NOT query_body_formula %prec T_UMINUS
{
	$$ = new SimpleUnaryOperator(SimpleUnaryOperator::UOP_NOT, $2);
							...
							| query_body_formula AND %prec T_AMP query_body_formula
{
	$$ = new SimpleBinaryOperator($1, SimpleBinaryOperator::BOP_AND, $3);
}
							| query_body_formula T_DBL_PLUS query_body_formula
{
	$$ = new SimpleBinaryOperator($1, SimpleBinaryOperator::BOP_OR, $3);
}
